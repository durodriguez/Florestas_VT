...
const fields = ['plant_id', 'taxon', 'lat', 'lng', 'collection', 'dbh_in', 'height_ft',
  ...
  'photo', 'dedicated', 'dedication_label', 'notes'];

const plants: Plant[] = expandPlants({
  fields,
  rows: [
    ['UVM-0001', 0, 44.4779, -73.1955, 0, 32, 68, 55, 1, 1908, 0, null, null, null, 0, null, null],
    ['UVM-0002', 0, 44.4780, -73.1950, 0, 6, 20, 15, 0, 2018, 0, null, null, null, 0, null, null],
    ['UVM-0003', 1, 44.4716, -73.1971, 1, 34, 88, 42, 1, 1895, 0, null, null, null, 0, null, null],
    ['UVM-0004', 2, 44.4767, -73.1849, 1, null, 12, 10, 1, null, 0, null, null, null, 0, null, null],
